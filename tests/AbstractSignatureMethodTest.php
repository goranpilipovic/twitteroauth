...
use GoranPilipovic\TwitterOAuth\SignatureMethod;
...
abstract class AbstractSignatureMethodTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return $this->getMockBuilder('GoranPilipovic\TwitterOAuth\Request')
    ...
    {
        return $this->getMockBuilder('GoranPilipovic\TwitterOAuth\Consumer')
    ...
    {
        return $this->getMockBuilder('GoranPilipovic\TwitterOAuth\Token')
